...
def home():
    ...
    if g.loggedin==None:
        Fname=''
    return render_template('user/layoutSearchResults-1.html',Fname=Fname,topProducts=topProducts,bodyScrub=bodyScrub,bathAndShower=bathAndShower,diaryAndEggs=diaryAndEggs,grain=grain,produce=produce,proteinProducts=proteinProducts)
